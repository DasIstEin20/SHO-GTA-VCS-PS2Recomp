/* REVIEW-ONLY: FUN_0045dea8 @ 0x0045dea8 */


undefined8 FUN_0045dea8(undefined8 param_1,undefined1 (*param_2) [16],uint param_3)

{
  ...
  if ((uVar14 & 7) != 0) goto LAB_0045e020;
  uVar16 = 8;
  if ((uVar14 & 0xf) == 0) {
    uVar16 = 0x10;
  }
  if ((uVar14 & 0xf) == 0) {
    if (param_3 < uVar16) goto LAB_0045e020;
    ...
    if (auVar12._0_8_ != 0 || auVar11._0_8_ != 0) goto LAB_0045e020;
    puVar10 = *param_2;
    ...
    *(undefined4 *)(pcVar15 + 0xc) = uVar8;
    ...
    if (param_3 < 0x10) goto LAB_0045e020;
    auVar11 = _psubb(*param_2,auVar17);
    auVar11 = _pand(auVar11,~*param_2);
    ...
    if (auVar11._0_8_ != 0 || auVar12._0_8_ != 0) goto LAB_0045e020;
